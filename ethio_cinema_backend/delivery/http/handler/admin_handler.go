...
func (ah *AdminHandler) AdminScheduleNew(w http.ResponseWriter, r *http.Request){
	...
	log.Println(ah.ssrv.ScheduleExists(sh.CinemaID, sh.MovieID, sh.Day, sh.StartingTime))
	if ah.ssrv.ScheduleExists(sh.CinemaID, sh.MovieID, sh.Day, sh.StartingTime){
